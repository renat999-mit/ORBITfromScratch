...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 25 09:31:14 2023
...
paper_data = np.loadtxt('hartman3_paper.txt')
# Open the pickle file in read mode
with open('hartman3_result.pkl', 'rb') as f:
    # Load the data from the file using pickle.load
    data_orbit = (pickle.load(f)).T

fig, ax = plt.subplots()
ax.set_title('Hartman3 ($d = 3$)')
